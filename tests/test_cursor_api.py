...
class SourceGuardTests(unittest.TestCase):
    def test_native_usage_report_entry_points(self) -> None:
        ...
        mac_delegate = (root / "macos" / "Sources" / "CursorRemain" / "AppDelegate.swift").read_text(encoding="utf-8")
        ...
        self.assertIn("InstanceIpc", mac_delegate)
        self.assertIn("forwardToRunningInstance", mac_delegate)
        self.assertIn(".settings", mac_delegate)
        self.assertIn(".report", mac_delegate)
        self.assertIn("openSettings", mac_delegate)
        self.assertIn("openReport", mac_delegate)
        mac_ipc = (root / "macos" / "Sources" / "CursorTokenCore" / "InstanceIpc.swift").read_text(encoding="utf-8")
        self.assertIn("func launchAction", mac_ipc)
        self.assertIn("--report", mac_ipc)
        self.assertIn("--settings", mac_ipc)
        mac_lock = (root / "macos" / "Sources" / "CursorTokenCore" / "InstanceLock.swift").read_text(encoding="utf-8")
        self.assertIn("guard let fd = acquiredFD else { return }", mac_lock)
        mac_protect = (root / "macos" / "Sources" / "CursorTokenCore" / "TokenProtector.swift").read_text(encoding="utf-8")
        self.assertIn("wrapKeyFileName = \"wrap-key\"", mac_protect)
        self.assertLess(mac_protect.index("readFileKey()"), mac_protect.index("readKey(account: keyAccount)"))
        self.assertIn("posixPermissions", mac_protect)
        self.assertIn("本机配置目录", (root / "macos" / "Sources" / "CursorRemain" / "SettingsView.swift").read_text(encoding="utf-8"))
        ...
        self.assertIn("Task.Run(() => CloudSync.Reconcile(snapshot))", win_prog)
        self.assertIn("ConfigStore.Clone(_config)", win_prog)
        self.assertIn("UiChrome.StyleMenu(_menu)", win_prog)
        self.assertIn("RefreshChrome", win_prog)
        self.assertIn("RefreshTheme", win_prog)
        ...
        self.assertIn("RefreshTheme", win_compare)
        self.assertIn("GoodText", win_compare)
        self.assertNotIn("SeaGreen", win_compare)
        ...
        self.assertIn("IconFont", win_chrome)
        ...
        self.assertIn("class FieldRowPanel", win_chrome)
        self.assertIn("class FlatTabHost", win_chrome)
        self.assertIn("void FitNav", win_chrome)
        self.assertIn("void ShowSelected", win_chrome)
        self.assertIn("void PreparePages", win_chrome)
        self.assertIn("FitOnce", win_settings)
        self.assertIn("void PreparePages", win_chrome)
        self.assertIn("NavWidth", win_chrome)
        self.assertIn("class FlatButton", win_chrome)
        self.assertIn("class DarkMenuRenderer", win_chrome)
        self.assertIn("ScrollBars.None", win_settings)
        self.assertIn("TabSizeMode.Fixed", win_chrome)  # owner-draw fallback for non-settings tabs
        self.assertIn("ButtonMinWidth", win_chrome)
        self.assertIn("SizeToText", win_chrome)
        self.assertIn("AutoSize = false", win_chrome)
        self.assertIn("HasCaption", win_chrome)
        self.assertIn("void Fit(int dpi)", win_chrome)
        self.assertIn("StyleMenu", win_settings)
        self.assertIn("RefreshChrome", win_settings)
        self.assertIn("Rgb Good", win_tone)
        self.assertIn("GoodText", win_chrome)
        self.assertIn("TabItemWidth", win_tone)
        self.assertIn("FieldMaxWidth", win_tone)
        self.assertIn("FieldWidthFill", win_tone)
        self.assertIn("FieldWidthShort", win_tone)
        self.assertIn("FieldWidthDuration", win_tone)
        self.assertIn("FieldWidthMedium", win_tone)
        self.assertIn("FieldWidthCombo", win_tone)
        self.assertIn("func fieldWidth", mac_settings)
        self.assertIn("func settingsMenuPicker", mac_settings)
        self.assertIn('Label(title, systemImage: "checkmark")', mac_settings)
        self.assertIn(".fixedSize(horizontal: true, vertical: false)", mac_settings)
        self.assertIn("func settingsDateTimeField", mac_settings)
        self.assertIn("func settingsDurationField", mac_settings)
        self.assertIn("SettingsDurationField", mac_settings)
        self.assertIn("SettingsFieldBox", mac_settings)
        self.assertIn(".menuIndicator(.hidden)", mac_settings)
        mac_datetime = (root / "macos" / "Sources" / "CursorRemain" / "SettingsDateTimeField.swift").read_text(encoding="utf-8")
        self.assertIn("static let radius: CGFloat = 6", mac_datetime)
        self.assertIn("static let height: CGFloat = 28", mac_datetime)
        self.assertIn('["一", "二", "三", "四", "五", "六", "日"]', mac_datetime)
        self.assertIn("firstWeekday = 2", mac_datetime)
        self.assertIn(".popover", mac_datetime)
        self.assertIn("yyyy-MM-dd HH:mm", mac_datetime)
        self.assertIn("class FieldFrame", win_chrome)
        self.assertIn("void LayoutInner", win_chrome)
        self.assertIn("PaintFieldBox", win_chrome)
        self.assertIn("PaintFieldRing", win_chrome)
        self.assertIn("ApplyRoundRegion", win_chrome)
        self.assertIn("ApplyRingRegion", win_chrome)
        self.assertIn("class FieldStrokeLayer", win_chrome)
        self.assertIn("InnerStroke", win_chrome)
        self.assertIn("FieldInset", win_tone)
        self.assertIn("inner is NumericUpDown", win_chrome)
        self.assertIn("CenterEdit", win_chrome)
        self.assertIn("FieldRowTag", win_chrome)
        self.assertIn("FieldPx", win_chrome)
        self.assertIn("FitFieldRows", win_settings)
        self.assertIn("FieldRowPanel", win_settings)
        self.assertIn("CollapseHiddenRows", win_settings)
        self.assertIn("FlatTabHost", win_settings)
        ...
        self.assertIn("addOpen", mac_settings)
        self.assertIn("pageHeight", mac_settings)
        self.assertIn("fittedBody", mac_settings)
        self.assertIn("SettingsBodyHeightKey", mac_settings)
        self.assertIn("SettingsMetrics", mac_settings)
        self.assertIn("func settingsPage", mac_settings)
        self.assertIn("alignment: .topLeading", mac_settings)
        self.assertIn("resizeTo", mac_settings)
        self.assertIn("addAccountSheet", mac_settings)
        self.assertIn(".sheet(isPresented: $addOpen)", mac_settings)
        self.assertIn("func fieldCaption", mac_settings)
        self.assertIn("ShowAddAccount", win_settings)
        self.assertIn("HoldsSpin", win_settings)
        self.assertIn("BuildAddDialog", win_settings)
        self.assertIn("CenterOverSettings", win_settings)
        self.assertIn("常规", win_settings)
        self.assertIn("NavWidth", (root / "windows" / "CursorTokenCore" / "UiLayout.cs").read_text(encoding="utf-8"))
        self.assertIn("TabGlyph", (root / "windows" / "CursorTokenCore" / "UiLayout.cs").read_text(encoding="utf-8"))
        self.assertIn("FitExtra", (root / "windows" / "CursorTokenCore" / "UiLayout.cs").read_text(encoding="utf-8"))
        self.assertIn("AddDialogWidth", (root / "windows" / "CursorTokenCore" / "UiLayout.cs").read_text(encoding="utf-8"))
        ...
        self.assertIn("public const int StackGap = 10", win_layout)
        self.assertIn("SettingsLayout.StackGap", win_settings)
        ...
        self.assertIn("HideNativeButtons", win_chrome)
        self.assertIn("TextAlign = HorizontalAlignment.Center", win_chrome)
        self.assertIn("BorderStyle.None", win_chrome)
        self.assertIn("ShowCalendar", win_chrome)
        self.assertIn("class FlatMonthView", win_chrome)
        self.assertIn("ShowTime", win_chrome)
        self.assertIn("NeedsTime", win_chrome)
        self.assertIn("class FlatUnitField", win_chrome)
        self.assertIn("DrawWheel", win_chrome)
        self.assertIn("AutoScaleMode.None", win_chrome)
        self.assertIn("FitToDpi", win_chrome)
        self.assertIn("CalendarLayout.Measure", win_chrome)
        self.assertIn("MinPopupWidth", win_chrome)
        win_layout = (root / "windows" / "CursorTokenCore" / "UiLayout.cs").read_text(encoding="utf-8")
        self.assertIn("class CalendarLayout", win_layout)
        self.assertIn("TimeColW = 96", win_layout)
        self.assertIn("class SettingsStamp", (root / "windows" / "CursorTokenCore" / "SettingsStamp.cs").read_text(encoding="utf-8"))
        self.assertIn("class FlatDigitBox", win_chrome)
        ...
        self.assertIn("new FlatUnitField", win_settings)
        ...
        self.assertIn("is NSHostingView<SettingsRootView>", mac_settings)
        ...
        reload_visible = mac_report.split("func reloadIfVisible")[1].split("func close")[0]
        self.assertIn("reloadForCurrentAccount", reload_visible)
        self.assertIn("store?.sync()", reload_visible)
        self.assertNotIn("objectWillChange.send()", reload_visible)
        persist_at = win_compare.find("_state().PersistCycle(acc.Id")
        sync_at = win_compare.find("UsageEvents.SyncAsync")
        self.assertGreater(persist_at, -1)
        self.assertGreater(sync_at, -1)
        self.assertGreater(persist_at, sync_at)
        ...
        self.assertIn("KeepLiveActiveAccount", (root / "windows" / "CursorTokenCore" / "AccountSync.cs").read_text(encoding="utf-8"))
        self.assertIn("KeepLiveActiveAccount", (root / "windows" / "CursorTokenCore" / "CloudSync.cs").read_text(encoding="utf-8"))
        self.assertIn("SessionActiveAccountId", (root / "windows" / "CursorTokenCore" / "AppConfig.cs").read_text(encoding="utf-8"))
        self.assertIn("string? liveActive = null", (root / "windows" / "CursorTokenCore" / "AccountSync.cs").read_text(encoding="utf-8"))
        self.assertIn("startedActive", (root / "macos" / "Sources" / "CursorRemain" / "AppStore.swift").read_text(encoding="utf-8"))
        self.assertIn("keepLiveActiveAccount", (root / "macos" / "Sources" / "CursorRemain" / "AppStore.swift").read_text(encoding="utf-8"))
        self.assertIn("func keepLiveActiveAccount", (root / "macos" / "Sources" / "CursorTokenCore" / "AccountSync.swift").read_text(encoding="utf-8"))
        self.assertIn("keepLiveActiveAccount", mac_settings)
        self.assertIn("applySyncedConfig", mac_settings)
