...
echo 请用 .NET 8 打包 Windows 自包含程序（无需另装 Desktop Runtime）：
echo   dotnet publish windows\CursorRemain\CursorRemain.csproj -c Release -r win-x64 --self-contained true -p:PublishSingleFile=true -p:EnableCompressionInSingleFile=true -o dist
echo.
